# How to Fix the 403 Error - Simple Steps

## What You Need to Do

1. **Connect to your Hostinger server** (open Terminal/Command Prompt):
```bash
ssh -p 65002 u933166613@82.180.152.127
```
Enter your password when asked.

2. **Copy and paste this entire command** (all lines at once):
```bash
cat > ~/FIX_403_COMPLETE.sh << 'SCRIPT'
#!/bin/bash
...
5. **After it finishes, test your website**:
   - Open: https://app.humancatalystbeacon.com/test.txt (should show "OK")
   - Open: https://app.humancatalystbeacon.com (your website)

6. **Clear your browser cache** (very important!):
   - **Chrome/Edge on Windows**: Press `Ctrl` + `Shift` + `Delete`
   - **Chrome/Edge on Mac**: Press `Cmd` + `Shift` + `Delete`
...
- ✅ Checks if your website is built
- ✅ Fixes file permissions (common cause of 403 errors)
- ✅ Creates required files for Hostinger
- ✅ Configures the web server correctly
- ✅ Restarts your backend server
...
The script will show you specific tests at the end. If `test.txt` works but your main site doesn't, the issue might be in your Hostinger control panel settings.

Let me know what happens after you run the script!
